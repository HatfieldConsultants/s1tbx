package org.esa.nest.gpf.laketools;
...
/**
 * The floating vegetation detection operator.
 * <p/>
 * The algorithm for detecting dark spots is based on inverse of adaptive thresholding. The thresholding is based on
...
@OperatorMetadata(alias = "Floating-Vegetation-Detection",
        category = "SAR Processing/Lake Tools/Floating Vegetation Detection",
        authors = "Daniel Lu",
        copyright = "Copyright (C) 2014 by Hatfield Consultants.",
        description = "Detect floating vegetation.")
public class FloatingVegetationDetectionOp extends Operator {
    ...
    public final static String FloatingVegetationMASK_NAME = "_floating_vegetation_bit_msk";
    ...
    public static void addBitmasks(final Product product) {
        for (Band band : product.getBands()) {
            if (band.getName().contains(FloatingVegetationMASK_NAME)) {
                ...
                mask.setDescription("Floating Vegetation Detection");
    ...
    private void addSelectedBands() throws OperatorException {
        ...
        for (Band srcBand : sourceBands) {
            ...
            final String targetBandName = srcBandNames + FloatingVegetationMASK_NAME;
    ...
    public static class Spi extends OperatorSpi {
        ...
        public Spi() {
            super(FloatingVegetationDetectionOp.class);
        }
    }
}
