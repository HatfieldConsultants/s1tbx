...
/**
 * The floating vegetation clustering and discrimination operator. The pixels detected as oil spill area are first
 * clustered and then discriminated based on the size of the cluster.
 */
@OperatorMetadata(alias = "Floating-Vegetation-Clustering",
...
public class FloatingVegetationClusteringOp extends Operator {
    ...
    public void initialize() throws OperatorException {
        try {
            ...
            FloatingVegetationDetectionOp.addBitmasks(targetProduct);
    ...
    private void addSelectedBands() throws OperatorException {
        ...
        for (Band srcBand : sourceBands) {
            ...
            if (!srcBandName.contains(FloatingVegetationDetectionOp.FloatingVegetationMASK_NAME)) {
    ...
    public static class Spi extends OperatorSpi {
        ...
        public Spi() {
            super(FloatingVegetationClusteringOp.class);
        }
    }
}
